/*
  ...
  --------------------------------------------------------------
    Military Base, Camp  by Ian Hardy - Ixxo, blackwiddow
...
if (true) then
{
  ...
  //_this setVehicleInitInit "this setvectorup [0,0,1]";
...
if (true) then
{
  ...
  //_this setVehicleInitInit "this allowDammage false;this enableSimulation false;";
